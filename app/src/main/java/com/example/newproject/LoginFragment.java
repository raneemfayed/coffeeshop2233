...
public class LoginFragment extends Fragment {
    ...
    public void onStart() {
        ...
        etUserNameSignup = getView().findViewById(R.id.etUsernameLogin);
        etPasswordSignup = getView().findViewById(R.id.etPasswordLogin);
        btnLogin = getView().findViewById(R.id.btnLoginLogin);
        tvSignupLink = getView().findViewById(R.id.tvSignupLinkLogin);
        forgotPasswordLogin = getView().findViewById(R.id.forgotPasswordLogin);
